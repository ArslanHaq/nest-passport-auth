...
$ npm run test:cov
```
### Difference between Vanilla Passport and NestPassport
```bash
 ...
 In @nestjs/passport, 
  1.   you configure a Passport strategy by extending the PassportStrategy class. 
      optionally passing in an options object. 
  2.  You provide the verify callback (item 2 above) by implementing a validate() method in your subclass.
